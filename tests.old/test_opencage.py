...
def test_opencage_paid():
    # Paid API keys can be set to unlimited and have rate limit information omitted from
    # the response
    url = (
        "http://api.opencagedata.com/geocode/v1/json?query=The+Happy+Goat%2C+Ottawa&limit=1&key="  # noqa
        + os.environ.get("OPENCAGE_API_KEY")
    )
